...
public class CParser implements CParserConstants {
    ...
    static final public ASTExpression RangeAtomicExpression() throws ParseException {
        ASTExpression e;
        Token tok, tok1;
        ASTExpression ret;
        ASTType type;
    ...
    static final public ASTExpression AtomicExpression() throws ParseException {
    ...
    static final public ASTProgram TranslationUnit() throws ParseException {
        Token name;
        ASTType t;
        ASTFunction f, b;
    ...
    static final public void PreDefine() throws ParseException {
        Token v;
        ASTExpression exp;
        jj_consume_token(69);
        v = jj_consume_token(IDENTIFIER);
    ...
    static final public List<ASTType> TypeVariablesInExp() throws ParseException {
        ASTType tyVar;
    ...
    static final public List<ASTType> TypeVariables() throws ParseException {
        ASTType tyVar;
        List<ASTType> ret = new ArrayList<ASTType>();
        jj_consume_token(72);
        tyVar = Type(ASTLabel.Secure);
    ...
    static final public long Constant() throws ParseException {
        Token n;
    ...
    static final public String StringConstant() throws ParseException {
        Token n;
    ...
    static final public long FloatConstant() throws ParseException {
        Token n;
    ...
    static final public ASTType Type(ASTLabel defaultLabel) throws ParseException {
        ASTType type;
    ...
    static final public Pair<ASTType, String> Argument() throws ParseException {
        ASTType ty;
        ASTFunctionType fty;
        Token v;
    ...
    static final public List<ASTStatement> Statements(ASTFunctionDef func) throws ParseException {
    ...
    static final public List<ASTStatement> Statement(ASTFunctionDef func) throws ParseException {
        List<ASTStatement> stmt = new ArrayList<ASTStatement>();
    ...
    static final public ASTExpression BIExpression() throws ParseException {
    ...
    static final public ASTExpression ShiftExpression() throws ParseException {
        ASTExpression e, old_e;
        ASTExpression n;
    ...
    static final public ASTExpression RangeExpression() throws ParseException {
        ASTExpression e, old_e;
        ASTExpression n;
    ...
    static final public ASTExpression RangeShiftExpression() throws ParseException {
        ASTExpression e, old_e;
        ASTExpression n;
    ...
    static final public ASTExpression ConstantExpression() throws ParseException {
        long n;
        long v;
        ASTExpression st;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
    ...
    static final public ASTExpression VariableExpression() throws ParseException {
        Token v;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case IDENTIFIER: {
                v = jj_consume_token(IDENTIFIER);
    ...
    static final public ASTExpression RangeAdditiveExpression() throws ParseException {
        ASTExpression e1, e2, old_e;
    ...
    static final public ASTExpression MultiplictiveExpression() throws ParseException {
        ASTExpression e1, e2, old_e;
        e1 = AtomicExpression();
        label_33:
        while (true) {
    ...
    static final public ASTExpression RangeMultiplictiveExpression() throws ParseException {
        ASTExpression e1, e2, old_e;
    ...
    static final public ASTPredicate Predicate() throws ParseException {
        ASTPredicate e;
        e = OrPredicate();
        {
            if ("" != null) return e;
    ...
    static final public ASTPredicate OrPredicate() throws ParseException {
    ...
    static final public ASTPredicate AndPredicate() throws ParseException {
        ASTPredicate e1, e2 = null, old_e;
        e1 = AtomicPredicate();
        label_36:
        while (true) {
    ...
    static final public ASTPredicate AtomicPredicate() throws ParseException {
        ASTPredicate p;
        ASTExpression e;
        boolean not = false;
        if (jj_2_16(3)) {
    ...
    static final public ASTPredicate BinaryPredicate() throws ParseException {
        ASTExpression e1, e2;
        REL_OP op;
        e1 = BIExpression();
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
